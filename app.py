...
def full_reset():
    ...
    # 2. Limpiar cache general de Streamlit (cubre @st.cache_data en todos los módulos)
    st.cache_data.clear()
    
    # 3. Limpiar lru_cache en módulos que lo usen
    try:
        ...
        with ThreadPoolExecutor(max_workers=10) as ex:
            ...
            for t in tickers:
                for m in mode_list:
                    ...
                    futures[ex.submit(analyze_ticker_for_today, t, current_regime, t_yield, s_date, e_date, False, m, preloaded_df, c_vix)] = (t, m)
                    time.sleep(0.02) # Pequeña pausa para no saturar las APIs
